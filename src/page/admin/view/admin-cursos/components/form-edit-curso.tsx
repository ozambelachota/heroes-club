...
export default function FormEditCurso({ onClose }: Props) {
  ...
  const {
    ...
    defaultValues: {
      ...
      fechaInicio: curso.fecha_inicio, // Use dayjs().toDate() to initialize with a valid Date object
      fechaFin: curso.fecha_final, // Use dayjs().toDate() to initialize with a valid Date object
  ...
  const onUpdateCurso: SubmitHandler<FormData> = (data) => {
    ...
    <div className="bg-slate-400  rounded-lg p-4 m-2">
      ...
      <Container maxWidth="sm">
        <form
          ...
          onSubmit={handleSubmit(onUpdateCurso)}
        >
          <Controller
            name="nombre-curso"
            control={control}
